        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                <div class="bg-slate-50 px-8 py-4 border-b border-slate-100">
                    <label class="block text-sm font-black text-slate-700 uppercase">Nội dung chi tiết</label>
                </div>
                <div class="p-2">
                    <textarea name="content" id="editor" placeholder="Nhập chi tiết giáo trình...">{{ old('content') }}</textarea>
                </div>
            </div>
        </div>
